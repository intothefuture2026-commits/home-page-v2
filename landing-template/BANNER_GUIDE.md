...
- 클릭 시 연결 동작: ① 문자상담 배너(top-banner-1) → 카카오톡 1:1 채팅 연결 (1844-1588은 SMS 수신이 안 되는 대표번호라 문자 앱 연결 대신 카카오톡으로 대체) / ③ 24시간 배너(top-banner-2) → 전화 연결(`tel:1844-1588`) / ②(이벤트 배너, 3곳 공통) → 방문예약 섹션(`#visit`). 링크 대상을 바꾸고 싶으시면 말씀해주세요.
